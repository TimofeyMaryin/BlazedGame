...
@Composable
fun ChooseGameMode(navController: NavController) {
    MenuContent(img = R.drawable.back_start) {
        ConstraintLayout(
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.btn_pvp),
                    contentDescription = null,
                    modifier = Modifier.fillMaxWidth(.8f).clickable { navController.navigate(Screen.GameZoneScreen.route) },
                    contentScale = ContentScale.FillWidth
                )
                Spacer(modifier = Modifier.height(DefaultSize.smallMargin))
                Image(
                    painter = painterResource(id = R.drawable.btn_pve),
                    contentDescription = null,
                    modifier = Modifier.fillMaxWidth(.8f).clickable { navController.navigate(Screen.PVEScreen.route) },
                    contentScale = ContentScale.FillWidth
                )
                Spacer(modifier = Modifier.height(DefaultSize.smallMargin))
                Image(
                    ...
                    contentDescription = null,
                    modifier = Modifier.fillMaxWidth(.8f).clickable { navController.navigate(Screen.RuleScreen.route) },
                    contentScale = ContentScale.FillWidth
                )
